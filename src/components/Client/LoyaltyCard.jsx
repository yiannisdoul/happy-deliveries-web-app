...
export default function LoyaltyCard({ stamps, rewardCount, useRewardOnThisJob, setUseRewardOnThisJob, monthlyDeliveryCount = 0 }) {
    ...
    // 2. Set Max Stamps dynamically based on Tier
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
                ...
                {rewardCount > 0 ? (
                    <div className="flex flex-col items-end">
                        ...
                        {/* NEW DISCLAIMER TEXT */}
                        {useRewardOnThisJob && (
                            <p className="text-[10px] text-green-800 mt-1 font-medium bg-green-100 px-1.5 py-0.5 rounded">
                                Value up to $160. No cash back.
                            </p>
                        )}
                    </div>
                ) : (
